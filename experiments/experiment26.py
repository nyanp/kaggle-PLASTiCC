...
class Experiment26(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment26.csv', n_loop=3):
        super().__init__(basepath=basepath,
                         ...
                         postproc_version=2,
                         pseudo_classes=[90, 42, 52, 62],
                         pseudo_n_loop=n_loop,
                         pseudo_th=0.975)
