...
blacklist = ['2__fft_coefficient__coeff_0__attr_"abs"',
 ...
 'sn_salt2_ncall',
 'salt2-extended_f_sn3_n_ncall']

# experiment49 replace f500 with f505 (SALT-2 with fixed photoz)
class Experiment49(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment49.csv', save_pseudo_label=False):
