...
# experiment33 + drop irrelevant features
class Experiment36(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment36.csv'):
