...
# experiment10 + torch loss
class Experiment14(ExperimentDualModel):
    def __init__(self, basepath):
        super().__init__(basepath=basepath,
                         ...
                         features_extra=['f000', 'f202', 'f100', 'f002', 'f104', 'f205', 'f010', 'f203', 'f200', 'f110',
                                         'f303', 'f304', 'f050', 'f400', 'f106', 'f107', 'f108','f140','f141','f142','f143','f144'],
                         model_inner=LGBMModel(nfolds=10, use_weight=False, use_torch_loss=True),
                         model_extra=LGBMModel(nfolds=10, use_weight=False, use_torch_loss=True),
                         submit_path='output/experiment14.csv',
                         log_name='experiment14',
