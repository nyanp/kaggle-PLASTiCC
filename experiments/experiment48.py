...
# experiment41 +  estimated z using salt-2
class Experiment48(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment48.csv', save_pseudo_label=False):
