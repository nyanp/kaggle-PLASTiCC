...
class Experiment53(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment53.csv', pseudo_n_loop=3, save_pseudo_label=False, use_extra_classifier=False):
        super().__init__(basepath=basepath,
                         ...
                         model_extra=LGBMModel(nfolds=10, weight_mode='weighted', use_extra_classifier=use_extra_classifier),
                         submit_path=submit_path,
                         log_name='experiment53_2',
