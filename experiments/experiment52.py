...
# experiment41 replace 500 with 506 (diversify)
class Experiment52(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment52.csv', save_pseudo_label=False):
