from experiments.experiments_triple import ExperimentTripleModel
from model.lgbm import LGBMModel

# experiment29 + triple
class Experiment31(ExperimentTripleModel):
    def __init__(self, basepath, submit_path='output/experiment31.csv'):
        super().__init__(basepath=basepath,
                         ...
                         features_extra2=['f000', 'f202', 'f100', 'f002', 'f104', 'f205', 'f010', 'f203', 'f200', 'f110',
                         ...
                         model_extra2=LGBMModel(nfolds=10, weight_mode='weighted'),
                         submit_path=submit_path,
                         log_name='experiment31',
                         ...
                         drop_feat_extra2=['ra', 'decl', 'gal_l', 'gal_b', 'distmod', 'hostgal_photoz'],
                         postproc_version=2,
