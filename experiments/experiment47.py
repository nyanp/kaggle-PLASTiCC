...
blacklist = ['2__fft_coefficient__coeff_0__attr_"abs"',
 ...
 'sn_salt2_ncall',
 'nugent-sn1bc_f_sn3_n_ncall'
             ]

# experiment46 + mamas top16 features
class Experiment47(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment47.csv', save_pseudo_label=False):
