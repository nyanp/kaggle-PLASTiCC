...
blacklist = ['2__fft_coefficient__coeff_0__attr_"abs"',
 ...
 'sn_salt2_ncall',
 'nugent-sn2n_f_sn3_n_ncall'
 ]

# experiment41 + f506 (nuget-sn2n template from sncosmo)
class Experiment45(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment45.csv', save_pseudo_label=True):
