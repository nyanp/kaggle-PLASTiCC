...
# experiment36 -> luminosity replaced with estimated photoz
class Experiment40(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment40.csv'):
