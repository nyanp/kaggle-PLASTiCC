...
class Experiment23(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment23.csv'):
        super().__init__(basepath=basepath,
                         ...
                         postproc_version=2,
                         pseudo_meta_path='input/meta_pseudo90_181116.f')
