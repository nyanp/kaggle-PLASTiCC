...
# experiment41 + mamas top16 features
class Experiment46(ExperimentDualModel):
    def __init__(self, basepath, submit_path='output/experiment46.csv', save_pseudo_label=False):
