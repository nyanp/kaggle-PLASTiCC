...
if __name__ == "__main__":
    ...
    exp = Experiment71(basepath='./', seed=seed, submit_path='experiment71_e_seed{}.csv'.format(seed), log_name='experiment71_pl',
                       use_extra_classifier=False, use_pl_labels=True)
    exp.execute()
